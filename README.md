...
int main(void)
{
  ...
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
      ...
      Lcd_cursor(&lcd, 0,1);
      Lcd_string(&lcd, "DEEPAK RAJ S");
      Lcd_cursor(&lcd, 1,1);
      Lcd_string(&lcd, "212222240013");
  /* USER CODE END 2 */
...
### AFTER 
![WhatsApp Image 2024-10-04 at 16 04 00_454c9f64](https://github.com/user-attachments/assets/fa5c059e-08f9-4729-9250-1b270194589f)
